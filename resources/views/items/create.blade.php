                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/items" enctype="multipart/form-data">
                            ...
                            <input type="number" class="form-control" name="price" id="price" step="0.01" min="0" placeholder="0.00" />

                            {{-- Item Quantity --}}
                            <label for="quantity" style="margin-top: 20px;">Quantity</label>
                            <input type="number" class="form-control" name="quantity" id="quantity" step="1" min="0" placeholder="0" />
